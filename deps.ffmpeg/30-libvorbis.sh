...
NAME='libvorbis'
VERSION='1.3.7'
URI='https://github.com/xiph/vorbis/releases/download/v1.3.7/libvorbis-1.3.7.tar.xz'
HASH="${SCRIPT_DIR}/deps.ffmpeg/checksums/libvorbis-1.3.7.tar.xz.sha256"
TARGETS=('x86_64' 'aarch64')
EXTRACTED_DIR='libvorbis-1.3.7'
