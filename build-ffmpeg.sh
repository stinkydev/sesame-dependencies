...
echo "  - libx265-dev (H.265 video codec)"
echo "  - libmp3lame-dev, libopus-dev, libvorbis-dev (audio codecs)"
echo "  - libaom-dev (AV1 support, optional: libsvtav1-dev)"
echo ""
echo "[INFO] Note: libx264 and libvpx are built from source automatically"
echo ""
echo "[INFO] To install on Ubuntu/Debian:"
echo "  sudo apt-get install -y nasm yasm libx265-dev \\"
