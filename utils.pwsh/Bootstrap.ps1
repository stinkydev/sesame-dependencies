function Bootstrap {
    <#
        .SYNOPSIS
            Bootstraps an sesame-deps build environment.
        .DESCRIPTION
            Prepares a build environment for sesame-deps including build dependencies as well as
    ...
    Write-Host '---------------------------------------------------------------------------------------------------'
    Write-Host -NoNewLine '[SESAME-DEPENDENCIES] - configuration '
